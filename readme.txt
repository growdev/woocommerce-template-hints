...
The code is maintained on <a href="https://github.com/growdev/woocommerce-template-hints">Github</a>
...
3. Go to WooCommerce > System Status
4. Click on the "Tools" tab
5. Check the box next to Template Hint and save settings
